...
export class FrontendAppComponent {
  ...
  onSubmit(){
    ...
    this.http.post<any>('https://sentiment-sentiment-project.apps.ai-dev01.kni.syseng.devcluster.openshift.com'+'/api/post_sentiment', { text: this.Sentence.value }).subscribe(data => {
