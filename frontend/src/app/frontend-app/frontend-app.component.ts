...
export class FrontendAppComponent {
  ...
  onSubmit(){
    ...
    this.http.post<any>('https://sentiment-sentiment-project.apps.rosa-7xzvq.cynv.p1.openshiftapps.com'+'/api/post_sentiment', { text: this.Sentence.value }).subscribe(data => {
